...
import type { TimelineSettings, DateFormat, Position, Shape, Scale, DatePosition } from "../../types/settings";

// Your app’s defaults when monday provides a “blank” payload (except dateColumn)
export const DEFAULT_SETTINGS: Omit<TimelineSettings, "dateColumn"> & { dateFormat: DateFormat } = {
...
export const ITEM_CAP = 15; // Hard cap on number of items to fetch/process
