...
export const SIZE_CONSTANTS = {
  ...
  CIRCLE_SIZE: DRAGGABLE_ITEM.CIRCLE_SIZE,
  RECTANGLE_WIDTH: DRAGGABLE_ITEM.RECTANGLE_WIDTH,
  RECTANGLE_HEIGHT_WITH_DATES: DRAGGABLE_ITEM.RECTANGLE_HEIGHT_WITH_DATES,
  RECTANGLE_HEIGHT_WITHOUT_DATES: DRAGGABLE_ITEM.RECTANGLE_HEIGHT_WITHOUT_DATES,
 ...
 */
export const calculateInitialSize = (
  shape,
  showItemDates,
  useLegacySizes = false,
) => {
  if (shape === "circle") {
    return {
 ...
 */
export const shouldUpdateSize = (
  currentSize,
  shape,
  showItemDates,
  useLegacySizes = false,
) => {
  const expectedSize = calculateInitialSize(
    shape,
    showItemDates,
    useLegacySizes,
  );
